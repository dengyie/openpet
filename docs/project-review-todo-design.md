...
| TypeScript 边界 | 已有 IPC 常量、共享 contracts、Control Center view contracts、API facade、Control Center hooks 和 `typecheck` | 继续扩展到 pane prop surfaces、main-process JSDoc adapters 和 high-drift service boundaries |
