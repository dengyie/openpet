...
| TypeScript 边界 | 已有 IPC 常量、共享 contracts、Control Center view contracts、API facade、Control Center hooks、Pane prop surfaces、首批 main-process Control Center adapters 和 `typecheck` | 继续扩展到 plugin / pet pack / About adapters 和 high-drift service boundaries |
