...
3. Decide whether the next extension phase should implement periodic health policy, stronger descendant-process cleanup guarantees, or continue evidence/report hardening.
