...
> Branch: `codex/creator-tools-asset-inspection-phase82`
...
4. Extend creator-tools beyond Phase 82 only through new host-mediated APIs such as sprite generation or pack-manifest workflows rather than raw plugin file writes.
