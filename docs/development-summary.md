...
> Branch: `codex/plugin-repository-provenance-rehearsal-phase76`
...
- Repository-provenance submission rehearsal evidence is archived under `docs/release-evidence/plugin-repository-provenance-rehearsal/2026-06-17T16-30-00Z/` using `examples/community-plugin-sources/weather-status-community.bundle` with clone source, ref, commit, package, submission bundle, and maintainer approval artifacts.
...
- Phase 76 is now complete: a Git-source plugin snapshot can now run through repository-provenance -> package -> submission bundle -> maintainer approval rehearsal, while the archive remains local repository-style workflow evidence rather than proof of independent public ecosystem trust.
...
3. Continue signed evidence/report hardening or gather live external community submission evidence beyond the current repository-provenance rehearsal.
