...
4. Extend creator-tools beyond Phase 83 only through host-mediated APIs such as pack-manifest workflows or user-approved picker imports rather than raw plugin file writes.
