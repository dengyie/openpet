...
| Node 原生 test runner | — | Service / release / IPC / example plugin / plugin submission / RC upgrade smoke / Codex pet import / desktop picker evidence 测试框架（311 个测试） |
...
**质量指标**：
- ✅ 311/311 Node 测试通过（service / release / 示例插件 / 插件提交校验、审核包、PR packet、workflow bundle 与 bundle validation、RC upgrade smoke、Codex pet import、Codex pet zip import 门禁覆盖）
