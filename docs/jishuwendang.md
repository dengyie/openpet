...
> **项目状态：v1.0 产品化基线完成；当前版本 v1.0.1-rc.1 用于 OpenPet 改名与升级兼容验证；macOS 分发基线已完成，Windows 打包/CI/签名策略/冒烟证据、报告、runbook 与 collector/证据包校验/summary/archive-manifest、desktop picker smoke evidence 工具基线已落地但尚未 release-ready**
...
| Node 原生 test runner | — | Service / release / IPC / example plugin / plugin submission / RC upgrade smoke / Codex pet import / Codex pet zip import / bundled Codex pets / desktop picker evidence 测试框架（317 个测试） |
...
**质量指标**：
- ✅ 317/317 Node 测试通过（service / release / 示例插件 / 插件提交校验、审核包、PR packet、workflow bundle 与 bundle validation、RC upgrade smoke、Codex pet import、Codex pet zip import、bundled Codex pets 门禁覆盖）
