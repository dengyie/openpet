...
- 面向开发者的本地扩展模型，当前兼容 legacy SDK，并支持显式 command、dashboard、service 控制、显式 command/service 的窄宠物 bridge（含只读动作发现和受限动作预设更新）、校验、日志、catalog 安装和卸载流程。
