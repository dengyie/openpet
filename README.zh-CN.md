...
项目使用 **Node 原生 test runner** 覆盖 service / release / IPC 路径，当前 **260 个测试全部通过**；同时维护 **Playwright Control Center UI 回归基线**，当前 9 个 UI 测试通过。
...
测试覆盖：
- ✅ Service / release / IPC 门禁覆盖（35 个测试文件）
