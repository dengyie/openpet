...
- Developer-first local extension model with current legacy SDK compatibility, explicit command/dashboard/service controls, narrow pet bridge access for explicit commands/services including read-only action discovery, validation, logs, catalog install, and uninstall flow.
